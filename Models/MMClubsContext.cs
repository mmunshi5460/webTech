...
{
    public partial class MMClubsContext : DbContext
    {
        public MMClubsContext()
        {
        }

        public MMClubsContext(DbContextOptions<MMClubsContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=localhost;Database=Clubs;Trusted_Connection=True;");
            }
        }
